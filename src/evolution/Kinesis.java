...
/**
 *
 * @author timbrochier Adapted from Kinesis fish movement described in Watkins &
 * Rose 2013
 */
...
// POUR LES 5 PARAMETRES SUIVANT : WATKINS ET ROSE 2013 - VALEURS ALGO GENETIQUE!!
    ...
    static double H2 = 0.9; // hauteur de la fonction de random
    static double H3 = 0.5; // hauteur de la fonction de extended Kinesis
    static double Qopt = 0.9; // valeur de optimal habitat
...
// EXTENTED KINESIS :   OKUNISHI et al. 2012
 //               System.out.println("EXTENTED KINESIS");
...
//double sigma_t; // largeur de la gaussienne autour de T_opt
    ...
    static double random(double phi, double Ih) {
        ...
        //--> a chercher : methode gaussienne bornée? [0 phi]?
        //--> sinon : (29 sept 2017)
        while (epsilon>phi || epsilon<-phi){
//            System.out.println("test en cours/ epsilon = : " + epsilon + "  : phi = " + phi);
